...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new util.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new util.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new util.datechooser.Button();
        cmdPrevious = new util.datechooser.Button();
        slide = new util.datechooser.Slider();
    ...
    private util.datechooser.Button cmdForward;
    private util.datechooser.Button cmdMonth;
    private util.datechooser.Button cmdPrevious;
    private util.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private util.datechooser.Slider slide;
