...
public class ParseHelper {
    ...
    public static Message checkCargo(String json){
        JSONObject j = new JSONObject(json);
        String field = "code";
        
        if(j.has("cargo")){
            JSONObject j2 = new JSONObject(j.getJSONObject(field));
            
            if(j2.has(field)){
                return ParseHelper.testOnlyNumber(j2.toString(), field, -1);
            }
    ...
    public static Message checkEquipamento(String json){
        JSONObject j = new JSONObject(json);
        String field = "code";
